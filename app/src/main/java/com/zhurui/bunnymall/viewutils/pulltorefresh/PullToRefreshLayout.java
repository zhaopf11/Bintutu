package com.zhurui.bunnymall.viewutils.pulltorefresh;
...
import com.zhurui.bunnymall.viewutils.pulltorefresh.pullableview.Pullable;
...
public class PullToRefreshLayout extends RelativeLayout {
		...
		if(refreshStateImageView != null && refreshStateTextView != null){
			switch (refreshResult) {
				case SUCCEED:
					...
					refreshStateImageView.setBackgroundResource(R.drawable.checkbox_checked);
					break;
				case FAIL:
				default:
					// 刷新失败
	...
	public void loadmoreFinish(int refreshResult) {
		...
		if(loadStateImageView != null && loadStateTextView != null){
			switch (refreshResult) {
				case SUCCEED:
					// 加载成功
					loadStateImageView.setVisibility(View.VISIBLE);
					loadStateTextView.setText(R.string.load_succeed);
					loadStateImageView.setBackgroundResource(R.drawable.checkbox_checked);
					break;
				case FAIL:
				default:
					// 加载失败
	...
	public void changeState(int to) {
		...
		case INIT:
			// 下拉布局初始状态
			if(refreshStateImageView != null && refreshStateTextView != null && pullView != null
					&& loadStateImageView != null && loadStateTextView != null){
		...
		case RELEASE_TO_REFRESH:
			// 释放刷新状态
			if(refreshStateTextView != null && pullView != null) {
		...
		case REFRESHING:
			// 正在刷新状态
			if(refreshingView != null && refreshStateTextView != null && pullView != null) {
				pullView.clearAnimation();
		...
		case RELEASE_TO_LOAD:
			// 释放加载状态
			if(loadStateTextView != null && pullUpView != null) {
		...
		case LOADING:
			// 正在加载状态
			if(loadingView != null && loadStateTextView != null && pullUpView != null) {
				pullUpView.clearAnimation();
